...
class UserInteraction{
    ...
    /**
     * extracts an integer which is between (inclusive)the min and max value
     * @param min is the lower bound
     * @param max is the upper bound
     * @return integer
    */
    public static int[] getNumber(String question, int count, int min, int max){
        boolean askAgain=false;
